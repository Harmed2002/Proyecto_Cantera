...
) ENGINE=InnoDB AUTO_INCREMENT=1120 DEFAULT CHARSET=latin1 COLLATE=latin1_spanish_ci COMMENT='Ciudades';
...
CREATE TABLE `conceptsnovelties` (
  ...
  PRIMARY KEY (`cncn_id`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=latin1 COLLATE=latin1_spanish_ci COMMENT='Conceptos de novedad';
...
CREATE TABLE `conceptspayments` (
  ...
  PRIMARY KEY (`cncp_id`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=latin1 COLLATE=latin1_spanish_ci COMMENT='Conceptos de pagos';
...
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=latin1 COLLATE=latin1_spanish_ci COMMENT='Paises';
...
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=latin1 COLLATE=latin1_spanish_ci COMMENT='Dispositivos';
...
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COLLATE=latin1_spanish_ci COMMENT='Carga de combustible en cubitanques';
...
CREATE TABLE `fuelsshopping` (
  ...
  CONSTRAINT `fuelsshopping_ibfk_3` FOREIGN KEY (`ccmb_identifproveedor`) REFERENCES `suppliers` (`prov_identif`)
...
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COLLATE=latin1_spanish_ci COMMENT='Movimiento de maquinas';
...
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COLLATE=latin1_spanish_ci COMMENT='Observaciones de maquinas';
...
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COLLATE=latin1_spanish_ci COMMENT='Pagos a maquinas';
...
CREATE TABLE `machinestypes` (
  ...
  PRIMARY KEY (`tmaq_id`)
) ENGINE=InnoDB AUTO_INCREMENT=9 DEFAULT CHARSET=latin1 COLLATE=latin1_spanish_ci COMMENT='Tipos de maquinas';
...
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COLLATE=latin1_spanish_ci COMMENT='Terceros';
...
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COLLATE=latin1_spanish_ci COMMENT='Proceso de produccion';
...
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COLLATE=latin1_spanish_ci COMMENT='Maestro de remisiones de materiales';
...
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COLLATE=latin1_spanish_ci COMMENT='Detalle de remisiones de materiales';
...
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COLLATE=latin1_spanish_ci COMMENT='Novedades de remisiones de materiales';
...
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COLLATE=latin1_spanish_ci COMMENT='Sociedades';
...
) ENGINE=InnoDB AUTO_INCREMENT=34 DEFAULT CHARSET=latin1 COLLATE=latin1_spanish_ci COMMENT='Departamentos de cada pais';
...
CREATE TABLE `suppliers` (
  ...
  CONSTRAINT `suppliers_ibfk_1` FOREIGN KEY (`prov_identif`) REFERENCES `persons` (`pers_identif`) ON UPDATE CASCADE
...
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COLLATE=latin1_spanish_ci COMMENT='Tanqueo de maquinas';
